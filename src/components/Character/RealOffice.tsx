...
Command: npx gltfjsx@6.2.15 public/models/realOffice.gltf 
*/
...
export function RealOffice(props: any) {
  const group = useRef();
  const { nodes, materials, animations }: any = useGLTF(
    '/models/realOffice.gltf',
  );
  ...
  useEffect(() => {
    ...
    // Update the material to use the video texture
    const videoTexture = new VideoTexture(video);
    videoTexture.flipY = false;
    materials.매테리얼.map = videoTexture;
  }, []);
...
useGLTF.preload('/models/realOffice.gltf');
